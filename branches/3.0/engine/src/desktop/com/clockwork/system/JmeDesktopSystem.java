...
public class JmeDesktopSystem extends JmeSystemDelegate {
    ...
    private JmeContext newContextLwjgl(AppSettings settings, JmeContext.Type type) {
        try {
            ...
            switch (type) {
                case Canvas:
                    ctxClazz = (Class<? extends JmeContext>) Class.forName("com.clockwork.system.lwjgl.LwjglCanvas");
                    break;
                case Display:
                    ctxClazz = (Class<? extends JmeContext>) Class.forName("com.clockwork.system.lwjgl.LwjglDisplay");
                    break;
                case OffscreenSurface:
                    ctxClazz = (Class<? extends JmeContext>) Class.forName("com.clockwork.system.lwjgl.LwjglOffscreenBuffer");
                    break;
                default:
    ...
    private JmeContext newContextJogl(AppSettings settings, JmeContext.Type type) {
        try {
            ...
            switch (type) {
                case Display:
                    ctxClazz = (Class<? extends JmeContext>) Class.forName("com.clockwork.system.jogl.JoglNewtDisplay");
                    break;
                case Canvas:
                    ctxClazz = (Class<? extends JmeContext>) Class.forName("com.clockwork.system.jogl.JoglNewtCanvas");
                    break;
                default:
                    throw new IllegalArgumentException("Unsupported context type " + type);
            }
