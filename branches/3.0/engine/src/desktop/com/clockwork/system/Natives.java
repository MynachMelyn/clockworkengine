...
public final class Natives {
    ...
    private static int computeNativesHash() {
        ...
        try {
            ...
            URL url = Thread.currentThread().getContextClassLoader().getResource("com/clockwork3/system/Natives.class");
    ...
    protected static boolean isUsingNativeBullet() {
        try {
            Class clazz = Class.forName("com.clockwork.bullet.util.NativeMeshUtil");
            return clazz != null;
