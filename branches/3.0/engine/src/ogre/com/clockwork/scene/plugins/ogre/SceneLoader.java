...
import com.clockwork.scene.plugins.ogre.matext.OgreMaterialKey;
import com.clockwork.util.PlaceholderAssets;
import com.clockwork.util.xml.SAXUtil;
import static com.clockwork.util.xml.SAXUtil.*;
...
public class SceneLoader extends DefaultHandler implements AssetLoader {
    ...
    private com.clockwork.scene.Node root;
    private com.clockwork.scene.Node node;
    private com.clockwork.scene.Node entityNode;
    private Light light;
    ...
    private void parseEntity(Attributes attribs) throws SAXException {
        ...
        entityNode = new com.clockwork.scene.Node(name);
    ...
    private void parseNode(Attributes attribs) throws SAXException {
        ...
        com.clockwork.scene.Node newNode = new com.clockwork.scene.Node(name);
        if (node != null) {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attribs) throws SAXException {
        if (qName.equals("scene")) {
            ...
            if (sceneName == null) {
                root = new com.clockwork.scene.Node("OgreDotScene" + (++sceneIdx));
            } else {
                root = new com.clockwork.scene.Node(sceneName + "-scene_node");
            }
