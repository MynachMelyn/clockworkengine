...
public class DemoMainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //listDemos.add(new DemoLaunchEntry("com.clockwork.androiddemo.TestSimpleWater", "Post processors - not working correctly due to missing framebuffer support, looks interresting :)"));
        ...
        //listDemos.add(new DemoLaunchEntry("com.clockwork.androiddemo.TestNiftyGui", ""));
