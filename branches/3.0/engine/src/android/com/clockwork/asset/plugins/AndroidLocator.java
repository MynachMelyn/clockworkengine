...
public class AndroidLocator implements AssetLocator {
    ...
    private class AndroidAssetInfo extends AssetInfo {
        ...
        public AndroidAssetInfo(com.clockwork.asset.AssetManager assetManager, AssetKey<?> key, String assetPath, InputStream in) {
    ...
    @Override
    public AssetInfo locate(com.clockwork.asset.AssetManager manager, AssetKey key) {
