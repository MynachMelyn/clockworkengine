...
public interface AudioSource {
    ...
    public enum Status {
         ...
         * This will be set if AudioSource#stop() } is called 
     ...
     * see AudioSource#setDryFilter(com.clockwork.audio.Filter) 
     */
    public Filter getDryFilter();

    /**
     * @return The AudioData} set previously with 
     * AudioSource#setAudioData(com.clockwork.audio.AudioData, com.clockwork.audio.AudioKey) }
     ...
     * The status will be changed when either the AudioSource#play() }
     * or AudioSource#stop() } methods are called.
     */
     ...
     * 
     * see AudioSource#setVelocity(com.clockwork.math.Vector3f)
     */
     ...
     * 
     * see AudioSource#setReverbFilter(com.clockwork.audio.Filter) 
     */
     ...
     * 
     * see AudioSource#setDirection(com.clockwork.math.Vector3f)
     */
