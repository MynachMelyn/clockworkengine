 ...
 * For those particular caches, either {@link #registerAssetClone(com.clockwork.asset.AssetKey, java.lang.Object) }
...
public interface AssetCache {
     ...
     * by using the {@link #getFromCache(com.clockwork.asset.AssetKey) } method.
     ...
     * {@link #getFromCache(com.clockwork.asset.AssetKey) } will return null.
     ...
     * acquired a cached asset (with {@link #getFromCache(com.clockwork.asset.AssetKey) })
    ...
    /**
     * Notifies the cache that even though the methods {@link #addToCache(com.clockwork.asset.AssetKey, java.lang.Object) }
     * or {@link #getFromCache(com.clockwork.asset.AssetKey) } were used, there won't
     * be a call to {@link #registerAssetClone(com.clockwork.asset.AssetKey, java.lang.Object) }
     ...
     * {@link #addToCache(com.clockwork.asset.AssetKey, java.lang.Object) }. 
