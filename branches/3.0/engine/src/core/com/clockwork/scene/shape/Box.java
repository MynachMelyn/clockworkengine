...
public class Box extends AbstractBox {
     ...
     * use the com.clockwork.scene.Spatial#setLocalTranslation(com.clockwork.math.Vector3f) }
     * and com.clockwork.scene.Spatial#setLocalRotation(com.clockwork.math.Quaternion) }
