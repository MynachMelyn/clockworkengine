 ...
 * 
 */
public abstract class CWSystemDelegate {

    protected final Logger logger = Logger.getLogger(CWSystem.class.getName());
    protected boolean initialized = false;
    protected boolean lowPermissions = false;
    protected Map<CWSystem.StorageFolderType, File> storageFolders = new EnumMap<CWSystem.StorageFolderType, File>(CWSystem.StorageFolderType.class);
    protected SoftTextDialogInput softTextDialogInput = null;

    public synchronized File getStorageFolder(CWSystem.StorageFolderType type) {
        ...
        switch (type) {
            ...
            case External:
                ...
                if (storageFolder == null) {
                    ...
                    storageFolder = new File(System.getProperty("user.home"), ".CW");
    ...
    public abstract CWContext newContext(AppSettings settings, CWContext.Type contextType);
