...
import com.clockwork.scene.SceneGraphVisitor;
...
public class BlenderKey extends ModelKey {
    ...
    /** Tells if the mipmaps will be generated by CW or not. By default generation is dependant on the blender settings. */
    ...
    /**
     * This enum tells the importer if the mipmaps for textures will be generated by CW. NEVER_GENERATE and ALWAYS_GENERATE are quite understandable GENERATE_WHEN_NEEDED is an option that checks if the texture had 'Generate mipmaps' option set in blender, mipmaps are generated only when the option is set
     * 
     */
