...
public class Converter {
    ...
    public static com.clockwork.math.Vector3f convert(javax.vecmath.Vector3f oldVec) {
        com.clockwork.math.Vector3f newVec = new com.clockwork.math.Vector3f();
        convert(oldVec, newVec);
        return newVec;
    }

    public static com.clockwork.math.Vector3f convert(javax.vecmath.Vector3f oldVec, com.clockwork.math.Vector3f newVec) {
        newVec.x = oldVec.x;
        newVec.y = oldVec.y;
        newVec.z = oldVec.z;
        return newVec;
    ...
    public static javax.vecmath.Vector3f convert(com.clockwork.math.Vector3f oldVec) {
        javax.vecmath.Vector3f newVec = new javax.vecmath.Vector3f();
        convert(oldVec, newVec);
        return newVec;
    }

    public static javax.vecmath.Vector3f convert(com.clockwork.math.Vector3f oldVec, javax.vecmath.Vector3f newVec) {
        newVec.x = oldVec.x;
        newVec.y = oldVec.y;
        newVec.z = oldVec.z;
        return newVec;
    ...
    public static javax.vecmath.Quat4f convert(com.clockwork.math.Quaternion oldQuat, javax.vecmath.Quat4f newQuat) {
    ...
    public static javax.vecmath.Quat4f convert(com.clockwork.math.Quaternion oldQuat) {
        javax.vecmath.Quat4f newQuat = new javax.vecmath.Quat4f();
        convert(oldQuat, newQuat);
        return newQuat;
    }

    public static com.clockwork.math.Quaternion convert(javax.vecmath.Quat4f oldQuat, com.clockwork.math.Quaternion newQuat) {
        newQuat.set(oldQuat.x, oldQuat.y, oldQuat.z, oldQuat.w);
        return newQuat;
    }

    public static com.clockwork.math.Quaternion convert(javax.vecmath.Quat4f oldQuat) {
        com.clockwork.math.Quaternion newQuat = new com.clockwork.math.Quaternion();
        convert(oldQuat, newQuat);
        return newQuat;
    }

    public static com.clockwork.math.Quaternion convert(javax.vecmath.Matrix3f oldMatrix, com.clockwork.math.Quaternion newQuaternion) {
    ...
    public static javax.vecmath.Matrix3f convert(com.clockwork.math.Quaternion oldQuaternion, javax.vecmath.Matrix3f newMatrix) {
    ...
    public static com.clockwork.math.Matrix3f convert(javax.vecmath.Matrix3f oldMatrix) {
        com.clockwork.math.Matrix3f newMatrix = new com.clockwork.math.Matrix3f();
        convert(oldMatrix, newMatrix);
        return newMatrix;
    }

    public static com.clockwork.math.Matrix3f convert(javax.vecmath.Matrix3f oldMatrix, com.clockwork.math.Matrix3f newMatrix) {
    ...
    public static javax.vecmath.Matrix3f convert(com.clockwork.math.Matrix3f oldMatrix) {
        javax.vecmath.Matrix3f newMatrix = new javax.vecmath.Matrix3f();
        convert(oldMatrix, newMatrix);
        return newMatrix;
    }

    public static javax.vecmath.Matrix3f convert(com.clockwork.math.Matrix3f oldMatrix, javax.vecmath.Matrix3f newMatrix) {
    ...
    public static com.bulletphysics.linearmath.Transform convert(com.clockwork.math.Transform in, com.bulletphysics.linearmath.Transform out) {
        convert(in.getTranslation(), out.origin);
        convert(in.getRotation(), out.basis);
        return out;
    }

    public static com.clockwork.math.Transform convert(com.bulletphysics.linearmath.Transform in,  com.clockwork.math.Transform out) {
