...
import com.clockwork.texture.Texture3D;
...
public class TestTexture3D extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        uvCoordsBuffer.setupData(Usage.Static, 3, com.clockwork.scene.VertexBuffer.Format.Float,
        ...
        Material material = new Material(assetManager, "CWtest/texture/tex3D.j3md");
        try {
